...
/*
    ...
    $iSubjectsCount     =   count($mPreparedContent['getCatalogLinkedSubjects']);
    ...
    */
      ...
      /*  if($iSubjectsCount){
            $sMainSubject   =   strtoupper(@$mPreparedContent['getCatalogLinkedSubjects'][0]['lcis_title']);        
        } */  
    ...
    for($iI = 0; $iI < $iSubjectsCount; $iI++){
        $sSubjectsToUse  .=  $mPreparedContent['getCatalogLinkedSubjects'][$iI]['lcis_title'].', ';
    }



    $sSubjectsToUse      =    strtoupper(substr($sSubjectsToUse , 0, strlen($sSubjectsToUse) - 2) );
    ...
    $pdf->MultiCell($iSecondOffset, '', $sSubjectsToUse, 0, 'L', 0, 1, '' ,'', true);
