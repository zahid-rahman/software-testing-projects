...
<head>
    <meta charset="UTF-8" />
    <title> Admin Dashboard Template | Dashboard </title>
	...
	<meta content="" name="author" />
     <!--[if IE]>
        ...
        <![endif]-->
    <!-- GLOBAL STYLES -->
    <link rel="stylesheet" href="<?php echo $rootdir ; ?>assets/plugins/bootstrap/css/bootstrap.css" />
    <link rel="stylesheet" href="<?php echo $rootdir ; ?>assets/css/main.css" />
    <link rel="stylesheet" href="<?php echo $rootdir ; ?>assets/css/theme.css" />
    <link rel="stylesheet" href="<?php echo $rootdir ; ?>assets/css/MoneAdmin.css" />
    <link rel="stylesheet" href="<?php echo $rootdir ; ?>assets/plugins/Font-Awesome/css/font-awesome.css" />
    <!--END GLOBAL STYLES -->

    <!-- CUSTOMIZED STYLES -->
    <link rel="stylesheet" href="<?php echo $rootdir ; ?>assets/alpha/jed/css/my_style.css" />
    <!--END CUSTOMIZED STYLES -->
    
    <!-- SRCIPTS -->
    <script src="<?php echo $rootdir ; ?>assets/plugins/jquery-2.0.3.min.js"></script>
    <!-- END SRCIPTS -->

    <!-- PAGE LEVEL STYLES -->
    <link href="<?php echo $rootdir ; ?>assets/css/layout2.css" rel="stylesheet" />
...
<body class="padTop53 " >
        ...
        <div id="top">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top " style="padding-top: 10px;">
                ...
                <header class="navbar-header">
                    ...
                    <a href="index.html" class="portal_name">
                    	<img src="<?php echo $rootdir ; ?>assets/alpha/jed/img/aun_logo_mini.png" />
                   		<span>Augustine University</span>
                   	</a>
                </header>
                <!-- END LOGO SECTION -->
                <ul class="nav navbar-top-links navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            ...
                            <li class="divider"></li>
                            <li><a href="<?php echo $rootdir; ?>portal/logout"><i class="icon-signout"></i> Logout </a>
                            </li>
                        </ul>
       ...
       <div id="left" >
            <div class="media user-media well-small">
                <a class="user-link" href="#">
                    <img class="media-object img-thumbnail user-img" alt="User Picture" src="<?php echo $rootdir ; ?>assets/img/user.gif" />
                </a>
                <br />
            ...
            <ul id="menu" class="collapse">
                ...
                <li class="panel active">
                    <a href="index.html" >
                        <i class="icon-table"></i> Portal Home
                 ...
                 <div class="row">
                    <div class="col-lg-12">
                        <div style="text-align: center;">
                            ...
                            <a class='alpha_dash_module_link'>
                            ...
                            <a href="<?php echo $rootdir; ?>course_reg" class='alpha_dash_module_link'>
                ...
                <hr />
                 ...
                 <!--TABLE, PANEL, ACCORDION AND MODAL  -->
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                Modal(Pop-up Dialog) Example
                            </div>
                            <div class="panel-body">
                                <button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal">
                                    Launch Demo Modal(Pop-up Dialog)
                                </button>
    ...
    <!-- GLOBAL SCRIPTS -->
    <script src="<?php echo $rootdir ; ?>assets/plugins/bootstrap/js/bootstrap.min.js"></script>
    <script src="<?php echo $rootdir ; ?>assets/plugins/modernizr-2.6.2-respond-1.1.0.min.js"></script>
    <!-- END GLOBAL SCRIPTS -->

    <!-- PAGE LEVEL SCRIPTS -->
    <!-- <script src="<?php echo $rootdir ; ?>assets/js/for_index.js"></script> -->
