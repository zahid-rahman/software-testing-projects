  ...
  <div class="form-group">
    <label for="sectionType" class="col-lg-3 control-label requiured">Pick Up Date</label>
    					...
    					<div class="col-lg-9">
                            ...
                            <div class="input-group input-append date" id="pickerDateAppend" data-date="'.date("Y-m-d",time()).'" data-date-format="yyyy-mm-dd">
                                <input id="pickupdatevalue" name="pickupdatevalue" required class="form-control datepicker" value="'.date("Y-m-d",time()).'"   type="date" data-provide="datepicker" >
