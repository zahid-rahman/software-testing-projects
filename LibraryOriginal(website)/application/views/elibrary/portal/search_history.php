...
?>						<!-- Beginning of modal code for upload -->
					  <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                            	<?php if($this->AppUser->isLiveHost()){

                            			echo '<div class="alert alert-danger"> This feature has been disabled on the "Live-host". Kindly contact your system admin for assistance. </div>';
                                                    ...
                                                    <tbody>
                                                    	<?php
															...
															foreach($aMySearches as $aVals){
 																$o .= "<tr class=''>" ;
																	$o .= "<td>".$iI."</td>" ;
																	$o .= "<td><a href=\"".elibraryPortalUrl($aVals['luss_search_type'].'/?'.$aVals['luss_query'])."\"  title=\"Search for \"".$aVals['luss_query']."\"  target = \"_blank\">".$aVals['luss_keyword']." </a></td>" ;
