...
<?php  $rootdir =eLibraryRootUrl(); ?>
    ...
    <script>
        ...
        var _interactive_app_admin_root     =       '<?php echo  interactiveAdminUrl(); ?>';
        var _interactive_app_user_root      =       '<?php echo  interactivePortalUrl(); ?>';
        var _interactive_app_root           =       '<?php echo  interactivePortalUrl(); ?>';
...
<script type="text/javascript" src="http://localhost/chats/arrowchat/external.php?type=js" charset="utf-8"></script>
   -->  
<?php
echo '<script src="'.elibraryAssetsLocation('js/system.js?='.md5(time())).'"> </script>';
echo '<script src="'.elibraryAssetsLocation('plugins/dataTables/jquery.dataTables.js').'"></script>';
?>  
    <script src="<?php echo elibraryAssetsLocation('plugins/wysihtml5/lib/js/wysihtml5-0.3.0.js'); ?>"></script>
    <script src="<?php echo elibraryAssetsLocation('plugins/wysihtml5/bootstrap-wysihtml5-0.0.2.min.js'); ?>"></script> 
    <script src="<?php echo elibraryAssetsLocation('plugins/bootstrap-wysihtml5-hack.js'); ?>"></script>
    ...
    uploadAsync: true,
    maxFileSize: <?php  echo __InteractiveMaxUploadSize() ; ?>,
    /*
